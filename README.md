...
| <a name="input_central_password"></a> [central\_password](#input\_central\_password) | Sophos Central password | `string` | `null` | no |
...
| <a name="input_private_subnet_prefix"></a> [private\_subnet\_prefix](#input\_private\_subnet\_prefix) | Prefix to attach to private subnets | `string` | `"private-subnet-"` | no |
...
| <a name="input_public_subnet_prefix"></a> [public\_subnet\_prefix](#input\_public\_subnet\_prefix) | Prefix to attach to public subnets | `string` | `"public-subnet-"` | no |
